...
export default function Experience() {
  ...
  const colorClasses = {
    blue: 'border-l-blue-400 bg-blue-900/30',
    purple: 'border-l-purple-400 bg-purple-900/30',
    green: 'border-l-green-400 bg-green-900/30',
    teal: 'border-l-teal-400 bg-teal-900/30',
    orange: 'border-l-orange-400 bg-orange-900/30'
  };
    ...
    <div className="min-h-screen bg-white relative">
      ...
      <div className="relative z-10">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-between h-16 items-center">
              ...
              <div className="hidden md:flex space-x-8">
                ...
                <Link href="/experience" className="text-white font-semibold">Experience</Link>
            ...
            {mobileMenuOpen && (
              <div className="md:hidden pb-4 border-t border-white/10 mt-2">
                <div className="flex flex-col space-y-2 pt-2">
                  ...
                  <Link href="/experience" className="text-white py-2 px-4 bg-white/10 rounded font-medium">Experience</Link>
        ...
        <div className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
          ...
          >
            <h1 className="text-5xl font-display font-bold text-white mb-4 drop-shadow-lg">Professional Experience</h1>
            <p className="text-xl text-gray-200">Cross-functional background spanning analytics, ML/AI, and operations</p>
          </motion.div>
          ...
          <div className="space-y-8">
            {timeline.map((item, index) => (
              <motion.div
                ...
                className={`border-l-4 pl-8 pb-8 backdrop-blur-md rounded-r-2xl p-6 ${colorClasses[item.color as keyof typeof colorClasses]}`}
              >
                <div className="text-sm font-semibold text-gray-300 mb-2">{item.period}</div>
                <h3 className="text-2xl font-bold text-white mb-1">{item.role}</h3>
                <p className="text-lg text-gray-200 mb-4">{item.company}</p>
                ...
                <div className="bg-white/10 rounded-lg px-4 py-2 inline-block">
                  <span className="text-sm text-gray-300">
                    <span className="font-semibold text-white">Technologies:</span> {item.tech}
                  </span>
                </div>
              </motion.div>
            ))}
          ...
          <motion.div
            ...
            transition={{ duration: 0.6 }}
            viewport={{ once: true }}
            className="mt-16 bg-gradient-to-r from-blue-900/40 to-purple-900/40 backdrop-blur-md rounded-2xl border-2 border-white/20 p-8"
          >
            <h2 className="text-3xl font-bold text-white mb-8 text-center">Skills Evolution</h2>
            <div className="space-y-4 text-center">
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <span className="px-4 py-2 bg-blue-900/50 text-white rounded-lg font-medium">Early Career</span>
                <span className="text-white text-2xl">→</span>
                <span className="text-gray-200">Operational Analytics + Systems Admin</span>
              </div>
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <span className="px-4 py-2 bg-purple-900/50 text-white rounded-lg font-medium">Mid Career</span>
                <span className="text-white text-2xl">→</span>
                <span className="text-gray-200">BI + Financial Analytics + Process Automation</span>
              </div>
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <span className="px-4 py-2 bg-teal-900/50 text-white rounded-lg font-medium">Current</span>
                <span className="text-white text-2xl">→</span>
                <span className="text-gray-200">Product/Workforce Analytics + ML/AI + Data Engineering</span>
              </div>
              <div className="flex items-center justify-center gap-4 flex-wrap">
                <span className="px-4 py-2 bg-green-900/50 text-white rounded-lg font-medium">Future</span>
                <span className="text-white text-2xl">→</span>
                <span className="text-gray-200">Research + Advanced AI Applications (PhD path)</span>
              </div>
            </div>
          </motion.div>
          ...
          >
            ...
            <p className="text-xl text-gray-200 mb-8">Let's discuss how my experience can benefit your organization</p>
