            ...
            {mobileMenuOpen && (
              ...
              >
                <div className="flex flex-col space-y-2 pt-4">
                  <Link href="/" className="text-gray-200 hover:text-white py-2 px-4 hover:bg-white/10 rounded font-medium" onClick={() => setMobileMenuOpen(false)}>Home</Link>
                  <Link href="/about" className="text-gray-200 hover:text-white py-2 px-4 hover:bg-white/10 rounded font-medium" onClick={() => setMobileMenuOpen(false)}>About</Link>
                  <Link href="/portfolio" className="text-white py-2 px-4 bg-white/10 rounded font-medium" onClick={() => setMobileMenuOpen(false)}>Portfolio</Link>
                  <Link href="/services" className="text-gray-200 hover:text-white py-2 px-4 hover:bg-white/10 rounded font-medium" onClick={() => setMobileMenuOpen(false)}>Services</Link>
                  <Link href="/experience" className="text-gray-200 hover:text-white py-2 px-4 hover:bg-white/10 rounded font-medium" onClick={() => setMobileMenuOpen(false)}>Experience</Link>
                  <Link 
                    href="/contact"
                    className="mt-2 px-6 py-2 bg-gradient-to-r from-teal-600 to-teal-500 text-white rounded-lg font-medium text-center"
          ...
          <div className="max-w-7xl mx-auto text-center">
            ...
            >
              ...
              <p className="text-xl md:text-2xl text-gray-200 mb-8 drop-shadow-lg">
                {projects.length}+ projects across Healthcare Analytics, ML/AI, Workforce Intelligence, 
        ...
        <footer className="bg-black/50 backdrop-blur-md border-t border-white/10 py-8">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex justify-center gap-6 mb-6">
              ...
              <a href="https://github.com/ayoolumi" target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-white transition-colors" title="GitHub">
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="text-center">
              <p className="text-gray-300">© 2025 Ayoolumi Melehon | Edinburgh/Stirling, Scotland</p>
            </div>
          </div>
        </footer>
      </div>
